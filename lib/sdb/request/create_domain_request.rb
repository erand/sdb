...
# Object to build of the HTTP Query Request to make a CreateDomain API call.
# Given the 'Domain Name' this class will construct the query request.
module SDB
  module Request #:nodoc: all
    class CreateDomainRequest < SDBRequest
      								           
      def initialize( domain_name, access_key_id, secret_key )
        super( 'CreateDomain', access_key_id, secret_key )
