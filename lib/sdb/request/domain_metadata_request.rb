...
# Object to build of the HTTP Query Request to make a DomainMetadata API call.
# Given the 'Domain Name' this class will construct the query request.
module SDB
  module Request #:nodoc: all
    class DomainMetadataRequest < SDBRequest
      								           
      def initialize( domain_name, access_key_id, secret_key )
        super( 'DomainMetadata', access_key_id, secret_key )
